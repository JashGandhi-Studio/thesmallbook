/* ============================================================
   ...
   device and offers them a "story file" (.json) to send to you
   (email / DM / GitHub issue).

   To publish a reader's story for EVERYONE:
   1. Open the .json file they sent you in any text editor
...
window.COMMUNITY_STORIES = [
  /* Paste approved reader stories here, e.g.:
  {
    "id": "s-1722000000-ab3xk",
    "title": "How I Finally Stopped Procrastinating",
    "author": "Priya S.",
    "bookId": "eat-that-frog",
    "cover": "",
    "pdf": "",
    "text": "The story text...",
    "date": "2026-08-01"
