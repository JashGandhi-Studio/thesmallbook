...
(function () {
  ...
  /* One source of truth: does this page use the new app shell? */
  function shellPresent() {
    return !!(document.querySelector(".tsb-bar") ||
  ...
  function renderChip() {
    ...
    /* Same rule as renderNav: where the app shell exists, the You tab is
       the single account surface. This footer chip is a third competing
       auth UI and must stand down. */
    if (shellPresent()) { slot.innerHTML = ""; return; }
